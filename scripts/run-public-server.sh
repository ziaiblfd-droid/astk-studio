...
export ASTK_HOST="${ASTK_HOST:-0.0.0.0}"
...
export ASTK_WORKERS="${ASTK_WORKERS:-10}"
export ASTK_MAX_CONCURRENT_JOBS="${ASTK_MAX_CONCURRENT_JOBS:-10}"
export ASTK_JOB_TIMEOUT="${ASTK_JOB_TIMEOUT:-21600}"
export ASTK_RETENTION_DAYS="${ASTK_RETENTION_DAYS:-1}"
export ASTK_MAX_UPLOAD_BYTES="${ASTK_MAX_UPLOAD_BYTES:-536870912}"
export ASTK_TRUST_PROXY="${ASTK_TRUST_PROXY:-1}"
