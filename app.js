...
function renderSequenceFeatures(results){
  ...
  function update(){
    ...
    const title=`${comparisonDisplayName(results,group)} · ${kind} · ${featureSelect.selectedOptions[0]?.textContent||feature}`;
